...
@Plugin(
        type = Command.class,
        menuPath = "Plugins>GelAnno>GelAnno 0.8.6")
public class GelAnno implements Command {
    @Override
    public void run() {
    ...
    public static final class Controller implements ActionListener {
        ...
        private static final String COORDINATE_LOG_HEADER = "GelAnno Coordinate Log";
        private static final String LEGACY_COORDINATE_LOG_HEADER = "WB Tool Coordinate Log";
        private static final String LAST_DIR_PREFERENCE = "gelanno.last_dir";
        private static final String LEGACY_LAST_DIR_PREFERENCE = "wbtool.last_dir";
        ...
        private LoadedImage openRgbImage() {
            ...
            if (lastDir != null) {
                ...
                if (prefDir == null) {
                    prefDir = Prefs.get(LEGACY_LAST_DIR_PREFERENCE, null);
                }
                if (prefDir != null) {
        ...
        private ParsedCoordinateLog parseCoordinateLog(String text) {
            ...
            if (!COORDINATE_LOG_HEADER.equals(header)
                    && !LEGACY_COORDINATE_LOG_HEADER.equals(header)) {
                throw new IllegalArgumentException(
                        "This does not begin with a recognized GelAnno or WB Tool Coordinate Log header.");
            }
        ...
        private boolean resolveCropGeometryConflicts(ParsedCoordinateLog parsed) {
            ...
            for (LoggedCrop crop : parsed.crops) {
                ...
                String message = cropName + " contains two crop descriptions that differ by up to "
                        ...
                        + "Which geometry should GelAnno use?";
                Object[] options = {
